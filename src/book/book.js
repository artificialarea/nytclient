...
// Since the job of the Book component is to only display the details and there are no interactions this can be a plain function component (book.js not Book.js)
